...
model = T5ForConditionalGeneration.from_pretrained("./saved_summarization_model", local_files_only=True)
tokenizer = T5Tokenizer.from_pretrained("./saved_summarization_model", local_files_only=True)
